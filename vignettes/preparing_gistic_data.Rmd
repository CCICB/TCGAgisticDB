...
```{r, eval=FALSE}
df_studynames <- read.csv(system.file("tcga_study_abbreviations.csv", package = "TCGAgisticDB"), strip.white = TRUE)
...
df_data |>
  ...
  readr::write_csv(paste0(system.file(package = "TCGAgisticDB"), "/cohorts.tsv"))
```
